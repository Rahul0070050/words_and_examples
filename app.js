...
facts?.forEach(fact => {
    savedFacts.innerHTML += `<li class="list-group-item px-3 border-0 rounded-3 list-group-item-primary mb-2"><h6 id="text">${fact.fact}</h6><h6 id="delete" onClick="deleteFact(${fact.key})"><img src="https://img.icons8.com/ios-glyphs/90/000000/delete-sign.png"/></h6><a href="whatsapp://send?text="${fact.text}">wh</a></li>`
});
...
function saveTheFact() {
    ...
    if (facts) {
        ...
        localStorage.clear('fact')
        facts.push({ key, fact })
        savedFacts.innerHTML += `<li class="list-group-item px-3 border-0 rounded-3 list-group-item-primary mb-2"><h6 id="text">${fact}</h6><h6 id="delete" onClick="deleteFact(${key})"><img src="https://img.icons8.com/ios-glyphs/90/000000/delete-sign.png"/></h6><a href="whatsapp://send?text="${fact}">wh</a></li>`
