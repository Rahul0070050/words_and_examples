    ...
    if (facts) {
        ...
        <li class="list-group-item px-3 border-0 rounded-3 list-group-item-primary mb-2">
            ...
            <div id="btns">
                ...
                <a href="whatsapp://send?text=${fact}" data-action="share/whatsapp/share" target="_blank"></a> 
